...
CREATE TABLE `banner_beranda` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deskripsi` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `data_form_pengaduan` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `status` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT 'belum_diproses',
...
CREATE TABLE `data_form_permohonan_informasi` (
  ...
  `no_telp_pengguna` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `dokumen_publik` (
  ...
  `deskripsi_halaman` mediumtext COLLATE utf8mb4_unicode_ci,
  `jenis_dokumen` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `gambar_sop_beranda` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `judul_sop` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_gambar`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `kategori_dokumen` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `jenis_dokumen` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `profil_ppid` (
  ...
  `kategori` varchar(70) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `tahun_dokumen_tampil`
--

DROP TABLE IF EXISTS `tahun_dokumen_tampil`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tahun_dokumen_tampil` (
  `id_tahun_dokumen` int unsigned NOT NULL AUTO_INCREMENT,
  `tahun_dokumen` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_tahun_dokumen`)
...
-- Dump completed on 2025-08-01 13:14:47
